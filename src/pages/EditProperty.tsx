      ...
      <div className="min-h-screen bg-luxury-black flex items-center justify-center p-4 text-white">
        <div className="glass-card p-10 rounded-[2rem] border border-white/10 text-center max-w-md shadow-2xl">
          ...
          <p className="text-white/60 text-sm mb-6">
            The listing document ID may have been deleted, or does not represent a valid property asset.
          </p>
  ...
  return (
    <div className="min-h-screen bg-luxury-black pt-24 pb-20 text-white relative">
      ...
      <div className="container mx-auto px-4 max-w-4xl text-center">
        <div className="mb-8">
          <h1 className="text-3xl font-display font-medium text-white mb-2">Edit Listing Certificate</h1>
          <p className="text-white/40 text-xs">Verify terms and data parameters for: <strong className="text-white">{listing.title}</strong></p>
        </div>

        {/* Instantiating ListingCreationModal as an embedded controller component in isOpen state */}

    ...
    <div className="min-h-screen bg-luxury-black pt-28 pb-20 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="max-w-4xl mb-16 md:mb-24">
          <p className="text-luxury-gold font-bold tracking-[0.3em] md:tracking-[0.4em] uppercase text-[9px] md:text-[10px] mb-4 md:mb-6 underline underline-offset-8 decoration-luxury-gold/30">Concierge Relations</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
          ...
          <div className="lg:col-span-12 xl:col-span-5 space-y-8 md:space-y-12">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
               <div className="glass-card p-8 md:p-10 rounded-[2.5rem] md:rounded-[3rem] group hover:border-luxury-gold/20 transition-all duration-700">
                 ...
                 <p className="text-white/20 text-xs md:text-sm font-light italic tracking-wider">+251 910 012 794</p>
               </div>
               <div className="glass-card p-8 md:p-10 rounded-[2.5rem] md:rounded-[3rem] group hover:border-luxury-gold/20 transition-all duration-700">
                 <div className="w-12 h-12 md:w-14 md:h-14 rounded-2xl bg-white/5 flex items-center justify-center text-luxury-gold mb-6 md:mb-8 group-hover:bg-luxury-gold group-hover:text-luxury-black transition-all duration-500">
                    <Mail size={20} />
                 ...
                 <p className="text-white/20 text-xs md:text-sm font-light italic tracking-wider">vip@amaanestate.com</p>
               </div>
            </div>
            ...
            <div className="glass-card p-8 md:p-12 rounded-[3rem] md:rounded-[4rem] space-y-8 md:space-y-10 relative overflow-hidden">
               ...
               <div className="flex gap-6 md:gap-8 group">
                 ...
                 <div>
                    ...
                    <p className="text-white/20 text-xs md:text-sm leading-relaxed font-light">Office Tower IV, Platinum District, <br />Jigjiga, Somali Region, Ethiopia</p>
                 </div>
               </div>
               ...
               <div className="pt-2">
                  <Button variant="outline" className="w-full border-white/5 bg-white/5 text-white hover:bg-luxury-gold hover:text-luxury-black transition-all duration-500 rounded-2xl md:rounded-3xl h-14 md:h-16 font-bold uppercase tracking-[0.2em] text-[9px] md:text-[10px]">
              ...
              <form className="space-y-6 md:space-y-8 relative z-10" onSubmit={(e) => e.preventDefault()}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                  <div className="space-y-3">
                    ...
                    <Input placeholder="Enter Your Name" className="bg-white/5 border-0 h-14 md:h-16 rounded-xl md:rounded-2xl text-white placeholder:text-white/10 text-base md:text-lg px-6 focus-visible:ring-luxury-gold/30" />
                  </div>
                  <div className="space-y-3">
                    <label className="text-[9px] md:text-[10px] uppercase tracking-[0.2em] font-bold text-white/20 ml-2">Reference Number</label>
                    <Input placeholder="+251 ..." className="bg-white/5 border-0 h-14 md:h-16 rounded-xl md:rounded-2xl text-white placeholder:text-white/10 text-base md:text-lg px-6 focus-visible:ring-luxury-gold/30" />
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="relative">
                    <select className="flex h-14 md:h-16 w-full rounded-xl md:rounded-2xl border-0 bg-white/5 px-6 text-base md:text-lg text-white focus:outline-none appearance-none cursor-pointer">
                ...
                <Button className="w-full bg-luxury-gold text-luxury-black hover:bg-white transition-all h-16 md:h-20 rounded-[1.5rem] md:rounded-[2rem] font-bold text-lg md:text-xl shadow-2xl shadow-luxury-gold/10">
